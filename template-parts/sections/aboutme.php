...
$design_description = "単なる装飾ではなく、情報設計に基づいた「使いやすく、迷わない」デザインを心がけています。Figmaを用いたカンプ作成から、ユーザーの行動フローを意識したUI設計まで一貫して対応可能です。";
...
$development_heading_args = [
    "sub" => "Development",
    "heading" => "開発・実装"
];

$development_description = "HTML/CSSをはじめ、React・Next.js・Astro・WordPressなど幅広い技術でWebサイトを構築します。静的サイトから動的な注文フォーム、テーマ開発まで柔軟に対応可能です。
...
$writing_description = "ユーザーに必要な情報が自然と伝わる、読みやすい文章を意識してライティングを行います。サービスや商品の魅力が正しく届くように、構成の整理から文体の最適化まで対応。
Webデザイン・UIと合わせて文章面からも体験価値を高めるコンテンツ制作を心がけています。";

$skills = [
    createSkill("design", $design_heading_args, $design_description, $skill_designs),
    createSkill("development", $development_heading_args, $development_description, $skill_developments),
];
?>
    ...
    <div class="p-aboutme__items">
        <div class="p-aboutme__profile">
            ...
            <div class="p-aboutme__meta u-scroll-fadein">
                <div class="p-aboutme__profile__name"><?php echo $about_title; ?></div>
                <div class="p-aboutme__profile__description"><?php echo $about_content; ?></div>
            </div>
        </div>
        <div class="p-aboutme__skills">
            <?php foreach ($skills as $skill) : ?>
                <div class="p-aboutme__skill u-scroll-fadein">
                    ...
                    <p class="p-aboutme__skill__description"><?php echo esc_html($skill["description"]); ?></p>
                    <div class="p-aboutme__skill__more">
                        <?php get_template_part("template-parts/components/button", "more", ["data_card" => $skill["dataset"]]); ?>
                    </div>
                    <ul class="u-card p-aboutme__skill__cards" data-card="<?php echo esc_html($skill['dataset']); ?>">
                        <?php foreach ($skill["skills"] as $s) : ?>
                            <li class="p-aboutme__skill__card">
                                <p class="p-aboutme__skill__name">
                                    <?php echo esc_html($s["name"]); ?>
                                </p>
                                <p class="p-aboutme__skill__caption"><?php echo esc_html($s["caption"]); ?></p>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </div>
            ...
            <div class="p-aboutme__skill u-scroll-fadein">
                ...
                <p class="p-aboutme__skill__description"><?php echo esc_html($writing_description); ?></p>
                <ul class="p-aboutme__skill__links">
